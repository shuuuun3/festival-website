  ...
  return (
    <div className={styles.wrapper} ref={tabBar_Ref}>
      <div className={styles.items}>
        <Link className={`${styles.item} ${styles.pamphlet}`} href="/function/pamphlet" scroll={false}>
          <img src="/icon/pamphlet.svg" alt="pamphlet" className={styles.icon_svg} />
        </Link>
        <Link className={`${styles.item} ${styles.timetable}`} href="/function/timetable" scroll={false}>
        ...
        <Link className={`${styles.item} ${styles.allEvents}`} href="/function/allEvents" scroll={false}>
